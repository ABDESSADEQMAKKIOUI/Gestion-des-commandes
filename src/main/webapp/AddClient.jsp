...
<body class="">
        ...
        <div class="container">
          <div class="row justify-content-center">
            <div class="col-lg-5 text-center mx-auto">
              ...
              <p class="text-lead text-white">Use these awesome app to gere commandes.</p>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="row mt-lg-n10 mt-md-n11 mt-n10">
          <div class="col-xl-4 col-lg-5 col-md-7 mx-auto">
            <div class="card z-index-0">
              ...
              <div class="card-body">
                <form action="ClientControler" method="post" role="form text-left">
                  <div class="mb-3">
                    <input type="text" class="form-control"  name="name" placeholder="Name" aria-label="Name" aria-describedby="email-addon">
                  </div>
                  <div class="mb-3">
                    <input type="email" class="form-control" name="prenom" placeholder="prenom" aria-label="prenom" aria-describedby="email-addon">
                  </div>
                  <div class="mb-3">
  ...
  <script src="ssets/js/core/bootstrap.min.js"></script>
